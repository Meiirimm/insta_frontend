...
export default function Header1 ({openModal}) {
        ...
        <div className="header">
            ...
            <div className="header-item">
                <div className="header-item-child">
                    <Link href="/">
                        <Image src={home} alt="home" className="image" />
                        <span>Главная</span>
                    </Link>
                </div>
                <div className="header-item-child">
                ...
                <div className="header-item-child">
                    <Image src={mess} alt="message" className="image" />
                    <span>Сообщения</span>
                </div>
                <div className="header-item-child">
                ...
                <button className="header-item-child" onClick={openModal}><Image src={newpost} alt="icon" className="image" /><span>Создать</span></button>
                <div className="header-item-child">
                    <Link href="/profile">
            ...
            <div className="header-more">
                <Image src={burger} alt="menu" className="image" />
                <span>Ещё</span>
            </div>
        </div>        
    )
